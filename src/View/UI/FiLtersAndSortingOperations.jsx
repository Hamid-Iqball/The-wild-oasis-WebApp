...
<div className="border-gray-50 dark:bg-Dark-100 dark:border dark:border-customGray-700 shadow-sm rounded-md p-1 flex gap-1">
  {filteringOptions.map((option, index) => (
    ...
    >
      ...
      <div className= 'dark:bg-Dark-100 dark:border dark:border-customGray-700 shadow-sm rounded-md flex gap-1 text-[14px] border-grey-2 active:border-customOrange-700'>
