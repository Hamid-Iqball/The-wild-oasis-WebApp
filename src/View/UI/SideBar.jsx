        ...
        <ul className='flex flex-col gap-3 mr-4'>
            <li className='hover:bg-slate-100 rounded-md hover:text-orange-800'> 
                <NavLink to='/dashboard' className={({isActive})=>
                  isActive ? 'flex justify-start gap-4 py-3 px-6 bg-slate-100 rounded-md text-orange-800 text-[1em]' :'flex justify-start gap-4 py-2 text-[1rem] px-6'
              }>
            ...
            <li className='hover:bg-slate-100 rounded-md hover:text-orange-800'>
                <NavLink to='/bookings' className={({isActive})=>
                  isActive ? 'flex justify-start gap-4 py-3 px-6 bg-slate-100 rounded-md text-orange-800 text-[1rem]':'flex justify-start gap-4 py-2 px-6 text-[1rem]'
              }> 
