  ...
  return (
    <div className=' p-1 '>
        <div className='p-2 text-start pb-4'>
            <h1 className='text-customOrange-700 my-2 text-3xl font-semibold'>Delete Cabin</h1>
        ...
        <div className='flex justify-end items-center gap-3'>
            ...
            <button className="border border-grey-500 py-2 px-3 text-white bg-customOrange-700 font-semibold rounded-md " onClick={onConfirm}>Delete</button>
        </div>
    </div>
  )
}
